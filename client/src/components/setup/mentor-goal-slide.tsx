    ...
    <Slide
      ...
      content={
        <div>
          ...
          What do you really want someone to take away from talking to your mentor? (1-2 sentences)
          </Typography>
          <TextField
            required
            data-cy="mentor-goal"
            placeholder = "I want to reach more people and help them go to a better place"
            type = "goal"
            variant="outlined"
            value={mentor.goal || ""}
            onChange={(e) =>
